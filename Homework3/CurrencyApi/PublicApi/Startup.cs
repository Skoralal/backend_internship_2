...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            grpc.Address = new Uri(_configuration.GetValue<string>("GrpcURL") ?? throw new ArgumentNullException("Cant find specified field in the configuration"));
        ...
        services.AddScoped<IncomingRequestsLogger>();
        services.AddScoped<FavoriteExchangesService>();
        ...
        options =>
        {
            options.UseNpgsql(connectionString: _configuration.GetConnectionString("CurrencyApi"),
                npgsqlOptionsAction: optionsBuilder =>
                {
                    ...
                    optionsBuilder.MigrationsHistoryTable(HistoryRepository.DefaultTableName, UsersDBContext.SchemaName);
